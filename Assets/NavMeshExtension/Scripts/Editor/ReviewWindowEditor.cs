...
namespace SWS
{
    ...
    public class ReviewWindowEditor : EditorWindow
    {
		...
		private static string imagePath = "/EditorFiles/NAV_smallLogo.png";
        ...
        [MenuItem("Window/NavMesh Extension/Review")]
        static void Init()
        {
        ...
        {		
			...
			EditorGUILayout.LabelField("Review NavMesh Extension", EditorStyles.boldLabel);
            ...
            {
				UnityEditorInternal.AssetStore.Open("content/16910");
                DisableRating();
            }
